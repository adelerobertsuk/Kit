...
Top of Kit is who is in the seat. The user picks:

- **Diane** — the cassette. Cooper to Diane. Talk to text. No AI reply. Just write it down.
- **Kit** — the partner. Talks back on a walk. Cute, not clingy.

MEM on the side lights is memory, not a fourth mode. Three red buttons only (Normal, Auto, Pursuit are the web skin's levels; the native Chair replaces that picker).

## Core experience

The user opens Kit, picks who is in the seat, taps or holds the voice control, speaks naturally, and optionally hears a short reply (Kit chair only). Kit owns the interaction channel, so it receives both the user's transcript and the model's exact response; do not try to record or scrape another AI app.
...
2. Complete at least two spoken turns with Gemini (Kit chair).
3. Say "Goodnight, Kit."
...
7. Switch to Diane. Speak. Diane writes without an AI reply.
